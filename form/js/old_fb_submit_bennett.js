...
window.onload = function () {
    document.getElementById('mybeform').addEventListener("submit", submitnominateForm);
}

var nom_rec = firebase.database().ref('bennett');
...
function recSaved() {
    document.getElementById("mybeform").reset();
